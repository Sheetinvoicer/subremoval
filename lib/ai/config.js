...
export const AI_CONFIG = {
  ...
  models: {
    [AI_PROVIDERS.CLAUDE]: {
      // Upgraded from claude-3-opus-20240229 to the current Opus model so the
      // shared assistant (/api/agents/chat) and report insights (/api/ai/action)
      // produce sharper, more useful responses.
