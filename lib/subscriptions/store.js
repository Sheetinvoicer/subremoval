...
import { resolvePlanFromPriceId as resolvePlanFromPriceIdConfig } from '@/lib/subscriptions/plans'
 ...
 * Delegates to the central tier configuration so Pro/Business (and any future
 * self-serve tier) stay in sync with lib/subscriptions/plans.js.
 */
export function resolvePlanFromPriceId(priceId) {
  return resolvePlanFromPriceIdConfig(priceId)
}
